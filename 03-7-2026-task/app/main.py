...
'''
✓ Cache GET /employees response for 60 seconds
✓ Cache GET /employees/{id} with per-record TTL
✓ Invalidate cache on every PUT/DELETE
✓ Store JWT session in Redis after login
✓ Log "CACHE HIT" vs "CACHE MISS" per request'''
